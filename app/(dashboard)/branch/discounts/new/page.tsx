...
export default function NewBranchDiscountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.applies_to === 'SPECIFIC_PRODUCTS') dataToSend.product_ids = formData.product_ids;
      if (formData.applies_to === 'SPECIFIC_CATEGORIES') dataToSend.category_ids = formData.category_ids;
  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-6 lg:p-8 @container">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Tambah Promo Lokal Baru</h1>
          <p className="text-muted-foreground">
            Buat aturan promo baru untuk cabang ini
          </p>
        </div>
      </div>
